package com.readhub.backend.global.response;
...
public class ErrorResponse {
    ...
    public static ErrorResponse of(Set<ConstraintViolation<?>> violationErrors) {
        return new ErrorResponse(null, ConstraintViolationError.of(violationErrors));
    }
